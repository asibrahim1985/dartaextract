...
@Entity
@Table(name="rid_data",indexes= {@Index(name = "riddata_ind_crdt", columnList = "create_date",unique = false)})
public class RidData {
	...
	@Column(name="face_guardian",columnDefinition="TEXT")
    private String faceGuaridan;
	
	@Column(name = "face_guardian_score",length = 5)
	private String faceGuaridanScore;
	
	@Column(name="irisleft_guardian",columnDefinition="TEXT")
    private String irisleftGuaridan;
	
	@Column(name = "irisleft_guardian_score",length = 5)
	private String irisleftGuaridanScore;
	
	@Column(name="irisright_guardian",columnDefinition="TEXT")
    private String irisrightGuaridan;
	
	@Column(name = "irisright_guardian_score",length = 5)
	private String irisrightGuaridanScore;
	...
	public RidData(long id, String rid, LocalDateTime creationDate, String regType, String uin, String lastName,
			...
			String civilfirstName, String leftIris, String rightIris, String face, String leftIrisScore,
			String rightIrisScore, String faceScore, String faceGuaridan, String faceGuaridanScore,
			String irisleftGuaridan, String irisleftGuaridanScore, String irisrightGuaridan,
			String irisrightGuaridanScore, String errormsg, String extracted, String status) {
		super();
		this.id = id;
		this.rid = rid;
		...
		this.faceGuaridan = faceGuaridan;
		this.faceGuaridanScore = faceGuaridanScore;
		this.irisleftGuaridan = irisleftGuaridan;
		this.irisleftGuaridanScore = irisleftGuaridanScore;
		this.irisrightGuaridan = irisrightGuaridan;
		this.irisrightGuaridanScore = irisrightGuaridanScore;
	...
	public String getFaceGuaridan() {
		return faceGuaridan;
	}



	public void setFaceGuaridan(String faceGuaridan) {
		this.faceGuaridan = faceGuaridan;
	}



	public String getFaceGuaridanScore() {
		return faceGuaridanScore;
	}



	public void setFaceGuaridanScore(String faceGuaridanScore) {
		this.faceGuaridanScore = faceGuaridanScore;
	}
	...
	public String getIrisleftGuaridan() {
		return irisleftGuaridan;
	}



	public void setIrisleftGuaridan(String irisleftGuaridan) {
		this.irisleftGuaridan = irisleftGuaridan;
	}



	public String getIrisleftGuaridanScore() {
		return irisleftGuaridanScore;
	}



	public void setIrisleftGuaridanScore(String irisleftGuaridanScore) {
		this.irisleftGuaridanScore = irisleftGuaridanScore;
	}



	public String getIrisrightGuaridan() {
		return irisrightGuaridan;
	}



	public void setIrisrightGuaridan(String irisrightGuaridan) {
		this.irisrightGuaridan = irisrightGuaridan;
	}



	public String getIrisrightGuaridanScore() {
		return irisrightGuaridanScore;
	}



	public void setIrisrightGuaridanScore(String irisrightGuaridanScore) {
		this.irisrightGuaridanScore = irisrightGuaridanScore;
	}
	...
	public String toString() {
		return "RidData [id=" + id + ", rid=" + rid + ", creationDate=" + creationDate + ", regType=" + regType
				...
				+ ", rightIris=" + rightIris + ", face=" + face + ", leftIrisScore=" + leftIrisScore
				+ ", rightIrisScore=" + rightIrisScore + ", faceScore=" + faceScore + ", errormsg=" + errormsg
				+ ", extracted=" + extracted + ", status=" + status + "]";
	}
